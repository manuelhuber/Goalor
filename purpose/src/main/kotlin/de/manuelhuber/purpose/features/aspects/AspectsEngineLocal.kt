...
class AspectsEngineLocal : AspectsEngine {
    private val aspects = hashMapOf(
            Id("0") to Aspect(id = Id("0"), name = "Health", color = "blue", completed = 50, owner = "0", weight = 2),
            Id("1") to Aspect(id = Id("1"), name = "Career", color = "red", completed = 75, owner = "0", weight = 3),
            Id("2") to Aspect(id = Id("2"), name = "Charity", color = "green", completed = 0, owner = "0", weight = 1),
            Id("3") to Aspect(id = Id("3"), name = "Social", color = "pink", completed = 0, owner = "0", weight = 3))
